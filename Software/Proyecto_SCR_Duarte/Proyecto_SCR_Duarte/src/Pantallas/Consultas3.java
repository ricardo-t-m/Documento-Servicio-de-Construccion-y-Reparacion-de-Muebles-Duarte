...
public class Consultas3 extends javax.swing.JDialog {

    Pedido ped = new Pedido();
    public Consultas3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Consultar Pedido");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ped.consultar3(seleccionarTipo, seleccionarCategoria, txtPrecio, txtFecha, txtNombre, txtCelular, txtDireccion, txtDescripción, txtComentarios, pedId);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String num= txtNumero.getText();
        int pedId =Integer.parseInt(num);
        ped.eliminarPedido2(pedId);
        dispose();
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        ...
        String num= txtNumero.getText();
        int pedId =Integer.parseInt(num);
        ped.modificarPedido3(tipo, categoria, precio, fecha, descripcion, comentarios, nombre, celular, direccion,pedId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultas3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Consultas3 dialog = new Consultas3(new javax.swing.JFrame(), true);
