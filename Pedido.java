...
public class Pedido {
    ...
    public void agregarPedido(String ped_tipo,String ped_categoria,double ped_precio,LocalDate fecha,String ped_descripcion,String ped_comentario,String nombre, int cli_celular, String cli_direccion){
        ...
        try{
           ...
           ps= conn.prepareStatement("INSERT INTO pedidos (ped_tipo ,ped_categoria,ped_precio,ped_fechaEntrega,ped_descripcion,ped_comentario,ped_cli_id ) VALUES(?,?,?,?,?,?,?)");
    ...
    public void listarPedidos(javax.swing.JTable tablaPedidos){
           ...
           conn=conect.getConection();
           String sql = "SELECT ped_id, ped_tipo ,ped_categoria,ped_precio,ped_fechaEntrega, cli_nombre, cli_celular, cli_direccion FROM pedidos, clientes WHERE cli_id = ped_cli_id";
    ...
    public void consultar(javax.swing.JComboBox<String> seleccionarTipo, javax.swing.JComboBox<String> seleccionarCategoria, javax.swing.JTextField txtPrecio ,javax.swing.JTextField txtFecha ,javax.swing.JTextField txtNombre, javax.swing.JTextField txtCelular ,javax.swing.JTextField txtDireccion ,javax.swing.JTextPane txtDescripcion ,javax.swing.JTextField txtComentarios, int pedId){
          try{
           ...
           ps= conn.prepareStatement("SELECT ped_tipo ,ped_categoria,ped_precio,ped_fechaEntrega, ped_descripcion,ped_comentario, cli_nombre, cli_celular, cli_direccion FROM pedidos,clientes WHERE ped_id=? AND cli_id=?");
           ps.setInt(1,pedId);
           ps.setInt(2,abc);
           res = ps.executeQuery();
    ...
    public void modificarPedido(String tipo, String categoria, double precio, LocalDate fecha, String Descripcion, String Comentario, String nombre, int celular, String direccion, int pedId){
         try{
           ...
           ps=conn.prepareStatement("update pedidos Set ped_tipo=? WHERE ped_id=?");
           ps.setString(1,tipo);
           ps.setInt(2, pedId);
           ps.execute();
           ps=conn.prepareStatement("update pedidos Set ped_categoria=? WHERE ped_id=?");
           ps.setString(1,categoria);
           ps.setInt(2, pedId);
           ps.execute();
           ps=conn.prepareStatement("update pedidos Set ped_precio=? WHERE ped_id=?");
           ps.setDouble(1,precio);
           ps.setInt(2, pedId);
           ps.execute();
           ps=conn.prepareStatement("update pedidos Set ped_fechaEntrega=? WHERE ped_id=?");
           Date ped_fecha = java.sql.Date.valueOf(fecha);
           ps.setDate(1,ped_fecha);
           ps.setInt(2, pedId);
           ps.execute();
           ps=conn.prepareStatement("update pedidos Set ped_descripcion=? WHERE ped_id=?");
           ps.setString(1,Descripcion);
           ps.setInt(2, pedId);
           ps.execute();
           ps=conn.prepareStatement("update pedidos Set ped_comentario=? WHERE ped_id=?");
